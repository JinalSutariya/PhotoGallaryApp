...
struct ItemListDatum: Decodable {
    ...
    let breadcrumbs: [BBreadcrumb]
    let urls: UUrls
    let links: ItemListDatumLinks
    let likes: Int
...
// MARK: - Breadcrumb
struct BBreadcrumb: Codable {
    let slug, title: String
    let index: Int
    let type: String
}

// MARK: - ItemListDatumLinks
struct ItemListDatumLinks: Codable {
...
struct UUser: Codable {
    ...
    let links: UUserLinks
    let profileImage: PProfileImage
...
// MARK: - ProfileImage
struct PProfileImage: Codable {
    let small, medium, large: String
}

// MARK: - Social
struct SSocial: Codable {
    let instagramUsername: String?
    let portfolioURL: String?
...
typealias ItemListData = [ItemListDatum]

// MARK: - Encode/decode helpers

class JJSONNull: Codable, Hashable {

    public static func == (lhs: JJSONNull, rhs: JJSONNull) -> Bool {
        return true
    }
...
class JJSONCodingKey: CodingKey {
    let key: String
