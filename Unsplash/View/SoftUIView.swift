...
//  Unsplash
//
//  Created by CubezyTech on 02/01/24.
//
...
extension SoftUIView {
    ...
    public static let defalutMainColorColor: CGColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
    ...
    public static let defalutShadowRadius: CGFloat = 10
